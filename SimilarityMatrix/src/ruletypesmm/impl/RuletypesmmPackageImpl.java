...
public class RuletypesmmPackageImpl extends EPackageImpl implements RuletypesmmPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getTrafo_Mms(), this.getMMNames(), null, "mms", null, 1, -1, Trafo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
