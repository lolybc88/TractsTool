// $ANTLR 3.3 Nov 30, 2010 12:45:30 USE.g 2011-09-27 13:30:33
...
@SuppressWarnings("all") public class USELexer extends Lexer {
    ...
    public final void mWS() throws RecognitionException {
        try {
            int _type = WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // USE.g:1703:3: ( ( ' ' | '\\t' | '\\f' | NEWLINE ) )
            // USE.g:1704:5: ( ' ' | '\\t' | '\\f' | NEWLINE )
            {
            // USE.g:1704:5: ( ' ' | '\\t' | '\\f' | NEWLINE )
            int alt1=4;
            switch ( input.LA(1) ) {
    ...
    public final void mML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // USE.g:1720:11: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // USE.g:1721:5: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); if (state.failed) return ;

            // USE.g:1721:10: ( options {greedy=false; } : . )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mREAL() throws RecognitionException {
        try {
            ...
            // USE.g:1763:5: INT ( '.' INT ( ( 'e' | 'E' ) ( '+' | '-' )? INT )? | ( 'e' | 'E' ) ( '+' | '-' )? INT )
            {
            mINT(); if (state.failed) return ;
            // USE.g:1763:9: ( '.' INT ( ( 'e' | 'E' ) ( '+' | '-' )? INT )? | ( 'e' | 'E' ) ( '+' | '-' )? INT )
            int alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    // USE.g:1763:10: '.' INT ( ( 'e' | 'E' ) ( '+' | '-' )? INT )?
                    {
                    match('.'); if (state.failed) return ;
                    mINT(); if (state.failed) return ;
                    // USE.g:1763:18: ( ( 'e' | 'E' ) ( '+' | '-' )? INT )?
                    int alt8=2;
    ...
    public final void mRANGE_OR_INT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // USE.g:1766:13: ( ( INT '..' )=> INT | ( REAL )=> REAL | INT )
            int alt11=3;
    ...
    public final void mESC() throws RecognitionException {
        try {
            // USE.g:1789:1: ( '\\\\' ( 'n' | 'r' | 't' | 'b' | 'f' | '\"' | '\\'' | '\\\\' | 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | '0' .. '3' ( '0' .. '7' ( '0' .. '7' )? )? | '4' .. '7' ( '0' .. '7' )? ) )
            // USE.g:1790:5: '\\\\' ( 'n' | 'r' | 't' | 'b' | 'f' | '\"' | '\\'' | '\\\\' | 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | '0' .. '3' ( '0' .. '7' ( '0' .. '7' )? )? | '4' .. '7' ( '0' .. '7' )? )
            {
            match('\\'); if (state.failed) return ;
            // USE.g:1791:6: ( 'n' | 'r' | 't' | 'b' | 'f' | '\"' | '\\'' | '\\\\' | 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | '0' .. '3' ( '0' .. '7' ( '0' .. '7' )? )? | '4' .. '7' ( '0' .. '7' )? )
            int alt17=11;
            switch ( input.LA(1) ) {
            case 'n':
                {
            ...
            switch (alt17) {
                ...
                case 8 :
                    ...
                    break;
                case 9 :
                    // USE.g:1799:8: 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT
                    {
                    ...
                    break;
                case 10 :
                    // USE.g:1800:8: '0' .. '3' ( '0' .. '7' ( '0' .. '7' )? )?
                    {
                    matchRange('0','3'); if (state.failed) return ;
                    // USE.g:1800:17: ( '0' .. '7' ( '0' .. '7' )? )?
                    int alt15=2;
    ...
    public final void mHEX_DIGIT() throws RecognitionException {
        try {
            // USE.g:1806:10: ( ( '0' .. '9' | 'A' .. 'F' | 'a' .. 'f' ) )
            // USE.g:1807:5: ( '0' .. '9' | 'A' .. 'F' | 'a' .. 'f' )
            {
    ...
    public final void mIDENT() throws RecognitionException {
        try {
            int _type = IDENT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // USE.g:1814:6: ( ( '$' | 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // USE.g:1815:5: ( '$' | 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
    ...
    public final void mVOCAB() throws RecognitionException {
        try {
            // USE.g:1822:6: ( '\\U0003' .. '\\U0377' )
            // USE.g:1823:5: '\\U0003' .. '\\U0377'
            {
