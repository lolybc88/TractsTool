...
public class TextPackageImpl extends EPackageImpl implements TextPackage {
	 ...
	 * @generated
	 */
	public EReference getProject_Root() {
	 ...
	 * @generated
	 */
	public EReference getFile_Lines() {
	 ...
	 * @generated
	 */
	public EAttribute getEntity_AbsoluteName() {
	...
	public void createPackageContents() {
		...
		createEReference(projectEClass, PROJECT__ROOT);
		...
		createEReference(fileEClass, FILE__LINES);

		entityEClass = createEClass(ENTITY);
		createEAttribute(entityEClass, ENTITY__NAME);
		createEReference(entityEClass, ENTITY__CONTAINER);
		createEAttribute(entityEClass, ENTITY__ABSOLUTE_NAME);
	...
	public void initializePackageContents() {
		...
		folderEClass.getESuperTypes().add(this.getEntity());
		fileEClass.getESuperTypes().add(this.getEntity());

		// Initialize classes and features; add operations and parameters
		initEClass(projectEClass, Project.class, "Project", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getProject_Root(), this.getEntity(), null, "root", null, 1, 1, Project.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(folderEClass, Folder.class, "Folder", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getFolder_Content(), this.getEntity(), this.getEntity_Container(), "content", null, 0, -1, Folder.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getFile_Lines(), this.getLine(), null, "lines", null, 0, -1, File.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getEntity_Container(), this.getFolder(), this.getFolder_Content(), "container", null, 0, 1, Entity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEntity_AbsoluteName(), ecorePackage.getEString(), "absoluteName", null, 0, 1, Entity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
