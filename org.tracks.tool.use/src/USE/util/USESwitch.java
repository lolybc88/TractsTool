...
public class USESwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case USEPackage.CLASS: {
				USE.Class class_ = (USE.Class)theEObject;
			...
			case USEPackage.OCL_EXPRESSION: {
			...
			case USEPackage.ENUMERATION_TYPE: {
			...
			case USEPackage.REFERENCE_TYPE: {
			...
			case USEPackage.ENUMERATION: {
				Enumeration enumeration = (Enumeration)theEObject;
				T result = caseEnumeration(enumeration);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case USEPackage.LITERAL: {
	 ...
	 * @generated
	 */
	public T caseClass(USE.Class object) {
		return null;
	}
