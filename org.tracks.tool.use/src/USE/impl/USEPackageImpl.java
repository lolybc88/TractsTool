...
import USE.AssocKind;
import USE.Association;
import USE.Attribute;
import USE.CollectionType;
import USE.CollectionTypes;
...
import USE.ReferenceType;
import USE.Role;
import USE.SimpleType;
import USE.SimpleTypes;
import USE.Type;
import USE.USEFactory;
...
public class USEPackageImpl extends EPackageImpl implements USEPackage {
	 ...
	 * @generated
	 */
	private EEnum assocKindEEnum = null;
	...
	public static USEPackage init() {
		...
		USEPackageImpl theUSEPackage = (USEPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof USEPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new USEPackageImpl());
	 ...
	 * @generated
	 */
	public EReference getClass_Invariants() {
	 ...
	 * @generated
	 */
	public EReference getOperation_Implementation() {
	 ...
	 * @generated
	 */
	public EAttribute getOCLExpression_Expr() {
	 ...
	 * @generated
	 */
	public EReference getEnumerationType_Enum() {
	 ...
	 * @generated
	 */
	public EAttribute getCollectionType_Type() {
	 ...
	 * @generated
	 */
	public EReference getCollectionType_BaseType() {
	 ...
	 * @generated
	 */
	public EReference getReferenceType_Class() {
	 ...
	 * @generated
	 */
	public EReference getRole_ClassName() {
	 ...
	 * @generated
	 */
	public EEnum getAssocKind() {
		return assocKindEEnum;
	}
	...
	public void createPackageContents() {
		...
		createEReference(classEClass, CLASS__INVARIANTS);
		...
		createEReference(operationEClass, OPERATION__IMPLEMENTATION);
		createEReference(operationEClass, OPERATION__TYPE);
		createEReference(operationEClass, OPERATION__PRE_CONDITION);
		createEReference(operationEClass, OPERATION__POST_CONDITION);
		...
		createEAttribute(oclExpressionEClass, OCL_EXPRESSION__EXPR);

		typeEClass = createEClass(TYPE);

		enumerationTypeEClass = createEClass(ENUMERATION_TYPE);
		createEReference(enumerationTypeEClass, ENUMERATION_TYPE__ENUM);

		collectionTypeEClass = createEClass(COLLECTION_TYPE);
		createEAttribute(collectionTypeEClass, COLLECTION_TYPE__TYPE);
		createEReference(collectionTypeEClass, COLLECTION_TYPE__BASE_TYPE);

		simpleTypeEClass = createEClass(SIMPLE_TYPE);
		createEAttribute(simpleTypeEClass, SIMPLE_TYPE__TYPE);

		referenceTypeEClass = createEClass(REFERENCE_TYPE);
		createEReference(referenceTypeEClass, REFERENCE_TYPE__CLASS);
	...
	public void initializePackageContents() {
		...
		initEClass(classEClass, USE.Class.class, "Class", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getClass_Name(), ecorePackage.getEString(), "name", null, 0, 1, USE.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getClass_Abstract(), ecorePackage.getEBoolean(), "abstract", null, 0, 1, USE.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClass_SuperClasses(), this.getClass_(), null, "superClasses", null, 0, -1, USE.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClass_Attributes(), this.getAttribute(), null, "attributes", null, 0, -1, USE.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClass_Operations(), this.getOperation(), null, "operations", null, 0, -1, USE.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClass_Invariants(), this.getOCLExpression(), null, "invariants", null, 0, -1, USE.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(modelEClass, Model.class, "Model", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getModel_Name(), ecorePackage.getEString(), "name", null, 0, 1, Model.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getModel_Classes(), this.getClass_(), null, "classes", null, 1, -1, Model.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getOperation_Implementation(), this.getOCLExpression(), null, "implementation", null, 0, 1, Operation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getOperation_PreCondition(), this.getOCLExpression(), null, "preCondition", null, 0, -1, Operation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getOperation_PostCondition(), this.getOCLExpression(), null, "postCondition", null, 0, -1, Operation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getOCLExpression_Expr(), ecorePackage.getEString(), "expr", null, 0, 1, OCLExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getEnumerationType_Enum(), this.getEnumeration(), null, "enum", null, 1, 1, EnumerationType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(collectionTypeEClass, CollectionType.class, "CollectionType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCollectionType_Type(), this.getCollectionTypes(), "type", null, 0, 1, CollectionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCollectionType_BaseType(), this.getType(), null, "baseType", null, 1, 1, CollectionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(simpleTypeEClass, SimpleType.class, "SimpleType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSimpleType_Type(), this.getSimpleTypes(), "type", null, 0, 1, SimpleType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(referenceTypeEClass, ReferenceType.class, "ReferenceType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getReferenceType_Class(), this.getClass_(), null, "class", null, 1, 1, ReferenceType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getAssociation_Kind(), this.getAssocKind(), "kind", null, 0, 1, Association.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getRole_Ordered(), ecorePackage.getEBoolean(), "ordered", null, 0, 1, Role.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getRole_ClassName(), this.getClass_(), null, "className", null, 1, 1, Role.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		// Initialize enums and add enum literals
		initEEnum(simpleTypesEEnum, SimpleTypes.class, "SimpleTypes");
		addEEnumLiteral(simpleTypesEEnum, SimpleTypes.INTEGER);
		addEEnumLiteral(simpleTypesEEnum, SimpleTypes.REAL);
		...
		addEEnumLiteral(collectionTypesEEnum, CollectionTypes.SEQUENCE);

		initEEnum(assocKindEEnum, AssocKind.class, "AssocKind");
		addEEnumLiteral(assocKindEEnum, AssocKind.ASSOCIATION);
		addEEnumLiteral(assocKindEEnum, AssocKind.COMPOSITION);
		addEEnumLiteral(assocKindEEnum, AssocKind.AGGREGATION);
