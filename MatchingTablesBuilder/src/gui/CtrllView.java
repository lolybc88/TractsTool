...
public class CtrllView implements ActionListener{
	...
	public void actionPerformed(ActionEvent e){
		if(e.getActionCommand().equals(View.RULE_TYPES)){
			w.ruleTypesClick();
		} else if(e.getActionCommand().equals(View.SRC_MM)){
			w.srcMMEcoreClick();
		} else if(e.getActionCommand().equals(View.CONSTRAINTS)){
			w.constraintsClick();
		} else if(e.getActionCommand().equals(View.TRG_MM)){
			w.trgMMEcoreClick();
		} else if(e.getActionCommand().equals(View.CSV_FILE)){
			w.csvFileClick();
		} else if(e.getActionCommand().equals(View.GET_MT)){
			w.getMatchingTablesClick();
		} 
	}	
}
